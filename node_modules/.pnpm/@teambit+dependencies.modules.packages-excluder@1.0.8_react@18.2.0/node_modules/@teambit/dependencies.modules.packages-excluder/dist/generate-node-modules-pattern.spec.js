    ...
    describe('default format for JEST', () => {
        describe('should work with empty array', () => {
            it('include any package in the node_modules', () => {
                expect((0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: [] })).toEqual('node_modules/(?!()/)');
            });
        });
        describe('should work with one package', () => {
            ...
            let regex;
            beforeAll(() => {
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: ['@myorg'] });
        ...
        describe('should work with more than one packages', () => {
            ...
            beforeAll(() => {
                ...
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: packagesToTransform });
                regex = new RegExp(pattern);
            });
        ...
        describe('should exclude components', () => {
            ...
            let regex;
            beforeAll(() => {
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ excludeComponents: true });
                regex = new RegExp(pattern);
            });
            const fixtures = [
            ...
            // @ts-ignore
            it.each(fixtures)(`should return %s for %s in yarn node_modules`, (expectedResult, pkgName) => {
                expect(regex.test(`node_modules/${pkgName}/`)).toEqual(expectedResult);
            });
            // @ts-ignore
            it.each(fixtures)(`should return %s for %s in pnpm node_modules`, (expectedResult, pkgName) => {
        ...
        describe('should exclude components and listed packages', () => {
            ...
            let regex;
            beforeAll(() => {
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: ['@myorg'], excludeComponents: true });
                regex = new RegExp(pattern);
            });
            it('should have yarn structure excluded', () => {
                expect(regex.test('node_modules/@myorg/something')).toBeFalsy();
        ...
        describe('should work with packages under the .pnpm directory', () => {
            ...
            let regex;
            beforeAll(() => {
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({
    ...
    describe('format for webpack', () => {
        describe('when packages provided is an empty array', () => {
            it('should return an empty string', () => {
                expect((0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: [], target: generate_node_modules_pattern_1.PatternTarget.WEBPACK })).toEqual('');
            });
        });
        describe('when packages contains a single package', () => {
            ...
            it('should return a single string pattern', () => {
                ...
                expect(pattern).toEqual('^(.+?[\\/]node_modules[\\/]\\.pnpm[\\/][^\\/]+[\\/]node_modules[\\/](?!(@my-org[\\/]my-scope.components))).+');
            });
        });
        describe('when packages are provided', () => {
            ...
            beforeAll(() => {
                patterns = [
                    (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({
            ...
            it('should exclude the packages from node modules', () => {
                expect(regexps.every((regexp) => regexp.test('node_modules/@my-org/my-scope.components/package.json'))).toBeFalsy();
                expect(regexps.every((regexp) => regexp.test('node_modules/@my-org/my-scope.components/dist/index.ts'))).toBeFalsy();
            });
            it('should exclude the packages from pnpm folder', () => {
                ...
                expect(regexps.every((regexp) => regexp.test('node_modules/.pnpm/@my-org+my-scope.components/dist/index.ts'))).toBeFalsy();
            });
            it('should exclude the packages from absolute paths', () => {
                expect(regexps.every((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/@my-org/my-scope.components/package.json'))).toBeFalsy();
            });
            it('should not exclude other packages', () => {
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/.pnpm/file+my-org+my-scope/node_modules/@my-org/my-scope.apps/package.json'))).toBeTruthy();
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/.pnpm/file+my-org+my-scope/node_modules/@lodash/package.json'))).toBeTruthy();
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/.pnpm/file+my-org+my-scope/node_modules/@react/package.json'))).toBeTruthy();
            });
        });
    });
});
//# sourceMappingURL=generate-node-modules-pattern.spec.js.map